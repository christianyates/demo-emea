...
if (file_exists('/var/www/site-php')) {
  if (preg_match('@([^\.]+)(\.(dev|stage))?\.eu\.demo\.acquia\.com$@', $_SERVER['HTTP_HOST'], $match) && file_exists("/var/www/site-php/cyates3/demo_{$match[1]}-settings.inc")) {
    require("/var/www/site-php/cyates3/demo_{$match[1]}-settings.inc");
    $conf['file_public_path'] = "sites/default/files/{$match[1]}";
  }
  else {
    require('/var/www/site-php/cyates3/cyates3-settings.inc');
